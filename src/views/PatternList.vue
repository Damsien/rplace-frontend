    ...
    <div id="screen">
        <div class="card m-4 p-2">
            <div class="row">
                ...
                <h1 class="col-8 text-center">All canvas</h1>
                <span class="col-2"></span>
            </div>
            <br />
            <h2 id="self-h2" v-if="patternsSts.self.length != 0">Your canvas</h2>
            ...
            <br />
            <h2 id="bind-h2" v-if="patternsSts.bind.length != 0">Registered canvas</h2>
